...
import {Card, createTheme, ThemeProvider} from "@material-ui/core";
...
import { ReactComponent as IconClassroom } from '../../NavBar/images/SVG/Navbar/Classroom.svg';
        ...
        return (
            <div>
                <ThemeProvider theme={theme}>
                    <HeaderTool name={keyword("classroom_title")} icon={<IconClassroom style={{ fill: "#51A5B2" }} />} advanced={false} />

                    <Card className={classes.rootNoPadding}>
                        <Box justifyContent="center" display="flex" flexDirection="column">
                            <Box mt={1} />

                            <Tabs indicatorColor="primary" value={value} onChange={handleChange} aria-label="simple tabs example" variant="fullWidth">
