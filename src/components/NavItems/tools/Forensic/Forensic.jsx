    ...
    return (
        <div>
            ...
            {//=== Title ===
                ...
                <HeaderTool name={keywordAllTools("navbar_forensic")} description={keywordAllTools("navbar_forensic_description")} icon={<ForensicIcon style={{ fill: "#51A5B2" }} width="40px"
            height="40px"/>} advanced="true" />
