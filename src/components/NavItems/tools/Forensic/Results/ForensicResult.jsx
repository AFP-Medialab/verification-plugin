...
import { setStateInit, setStateBackResults } from "../../../../../redux/reducers/tools/gifReducer"
...
const ForensicResults = (props) => {
    ...
    const [anchorFilterExplanation, setAnchorFilterExplanation] = React.useState(false);
                                        ...
                                        <CardHeader
                                            title={
                                                <Grid
                                                    ...
                                                    <Grid item>
                                                        <Button variant="contained" style={{ backgroundColor: "#FFFFFF", color:'black' }} onClick={newImage}>
                                                        ...
                                                        return (
                                                            <Grid key={key} item xs={4} >
                                                                ...
                                                                <Box align="center" width="100%" className={classes.lensesTitles}>
                                                                    ...
                                                                    <Popover
                                                                        id={idExpl}
                                                                        open={value.popover!==undefined  ? value.popover : false}
