...
const Deepfake = () => {
    ...
    return (
        <div>
            ...
            <HeaderTool name={keywordAllTools("navbar_deepfake_video")} description={keywordAllTools("navbar_deepfake_video_description")} icon={<AnalysisIcon style={{ fill: "#51A5B2" }} />} />
