...
const Deepfake = () => {
    ...
    return (
        <div>
            ...
            <HeaderTool name={keywordAllTools("navbar_deepfake_video")} description={keywordAllTools("navbar_deepfake_video_description")} icon={<DeepfakeIcon style={{ fill: "#51A5B2", height: "75px", width: "auto" }} />} />
