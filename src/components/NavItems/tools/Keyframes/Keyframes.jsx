...
const Keyframes = () => {
    ...
    */
    ...
    return (
        <div>
            <HeaderTool name={keywordAllTools("navbar_keyframes")} description={keywordAllTools("navbar_keyframes_description")} icon={<KeyframesIcon style={{ fill: "#51A5B2" }}  width="40px"
            height="40px"/>}/>
