...
const MetadataImageResult = (props) => {
  ...
  let softwareInfos = [
    ...
    },
    {
      ...
      value: report.XResolution
        ? report.XResolution.numerator / report.XResolution.denominator
        : null,
      description: keyword("metadata_img_software_desc_4"),
    },
    {
      title: keyword("metadata_img_software_fields_5"),
      value: report.YResolution
        ? report.YResolution.numerator / report.YResolution.denominator
        : null,
    ...
    },
    {
      ...
      value: report.YCbCrPositioning
        ? report.YCbCrPositioning === 1
          ? "Centered (add tsv)"
          : "Co-sited (add tsv)"
        : null,
  ...
  let exifInfos = [
    ...
    },
    {
      ...
      value: report.ExposureTime
        ? report.ExposureTime.numerator / report.ExposureTime.denominator
        : null,
      description: keyword("metadata_img_general_desc_4"),
    },
    {
      title: keyword("metadata_img_general_fields_5"),
      value: report.FNumber
        ? report.FNumber.numerator / report.FNumber.denominator
        : null,
    ...
    },
    {
      ...
      value: report.CompressedBitsPerPixel
        ? report.CompressedBitsPerPixel.numerator /
          report.CompressedBitsPerPixel.denominator
        : null,
    ...
    },
    {
      ...
      value: report.MaxApertureValue
        ? report.MaxApertureValue.numerator /
          report.MaxApertureValue.denominator
        : null,
    ...
    },
    {
      ...
      value: report.FocalLength
        ? report.FocalLength.numerator / report.FocalLength.denominator
        : null,
    ...
    },
    {
      ...
      value: report.MakerNoteSafety
        ? report.MakerNoteSafety === 1
          ? "Safe (add tsv"
          : "Unsafe (add tsv)"
        : null,
  ...
  let gpsInfo = [
    ...
    },
    {
      ...
      value: report.GPSTimeStamp
        ? report.GPSTimeStamp[0] +
          ":" +
          report.GPSTimeStamp[1] +
          ":" +
          report.GPSTimeStamp[2]
        : null,
