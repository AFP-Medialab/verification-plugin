  ...
  if (report.videoTracks[0]) {
    videoTrack = [
      ...
      },
      {
        ...
        value:
          report.videoTracks[0].references &&
          report.videoTracks[0].references.length > 0
            ? report.videoTracks[0].references.toString()
            : null,
        description: keyword("track_name_2"),
      },
      {
        title: keyword("track_name_3"),
        value: report.videoTracks[0].created
          ? report.videoTracks[0].created.toString()
          : null,
        description: keyword("track_name_3"),
      },
      {
        title: keyword("track_name_4"),
        value: report.videoTracks[0].modified
          ? report.videoTracks[0].modified.toString()
          : null,
  ...
  if (report.tracks[1] && report.tracks[1].audio)
    audioTrack = [
      ...
      },
      {
        ...
        value:
          report.tracks[1].references && report.tracks[1].references.length > 0
            ? report.tracks[1].references.toString
            : null,
        description: keyword("audio_desc_2"),
      },
      {
        title: keyword("audio_name_3"),
        value: report.tracks[1].created
          ? report.tracks[1].created.toString()
          : null,
        description: keyword("audio_desc_3"),
      },
      {
        title: keyword("audio_name_4"),
        value: report.tracks[1].modified
          ? report.tracks[1].modified.toString()
          : null,
  ...
  return (
    <Card>
      ...
      <div className={classes.root2}>
        ...
        <Box m={3} />
        <Typography variant={"h5"}>{keyword("track_title")}</Typography>
        <div>
          <Table size="small" aria-label="a dense table">
            <TableBody>
              {videoTrack &&
        ...
        {audioTrack && (
          <div>
            <Typography variant={"h5"}>{keyword("audio_title")}</Typography>
            <div>
              <Table size="small" aria-label="a dense table">
                <TableBody>
