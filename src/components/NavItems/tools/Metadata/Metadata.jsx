...
const Metadata = () => {
    ...
    return (
        <div>
            <HeaderTool name={keywordAllTools("navbar_metadata")} description={keywordAllTools("navbar_metadata_description")} icon={<MetadataIcon style={{ fill: "#51A5B2" }} width="40px"
            height="40px"/>} />
