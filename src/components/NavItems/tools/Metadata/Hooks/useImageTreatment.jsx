        ...
        let imageTreatment = () => {
            ...
            img.onload = () => {
                EXIF.getData(img, () => {
                    ...
                    //console.log(res);
                    if (!isEmpty(res)) {
                        dispatch(setMetadadaResult({url: mediaUrl, result: res, notification: false, loading: false, isImage: true}));
                    } else
                        dispatch(setMetadadaResult({url: mediaUrl, result: {message: "metadata_img_error_exif"}, notification: false, loading:false, isImage:true}));
                });
            };
            img.onerror = (error) => {
                handleErrors(error)
