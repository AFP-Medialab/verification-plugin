...
import { setGeolocationLoading, setGeolocationResult } from "../../../../../redux/reducers/tools/geolocationReducer";
            ...
            axios.get(caa_localtion_base_url+"geolocate?image_url=" + url + "&use_gradcam=0")
                .then(response => {
                    ...
                    if (response.data != null) {
                        dispatch(setGeolocationResult({urlImage:url, result:response.data.predictions, loading:false}));
                    } else {
