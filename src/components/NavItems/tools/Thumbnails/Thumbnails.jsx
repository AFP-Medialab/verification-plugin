...
const Thumbnails = () => {
   ...
   // const response = getHeight();
    ...
    return (
        <div>
            <HeaderTool name={keywordAllTools("navbar_thumbnails")} description={keywordAllTools("navbar_thumbnails_description")} icon={<ThumbnailsIcon style={{ fill: "#51A5B2" }} width="40px"
            height="40px"/>} />
