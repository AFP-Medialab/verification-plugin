...
<Box m={1}>
            ...
            alignItems="flex-start">
                ...
                <Grid item xs={4}>
                <Typography variant="h6">{this.state.tweets}</Typography><Typography variant="body1">{this.props.keyword("user_tweets")}</Typography>
                </Grid>


                <Grid item xs={4}>
                <Typography variant="h6">{this.state.tweets_per_day}</Typography><Typography variant="body1">{this.props.keyword("user_tweets_average")}</Typography>
                </Grid>

                <Grid item xs={4}>
                <Typography variant="h6">{this.state.lists}</Typography><Typography variant="body1">{this.props.keyword("user_lists")}</Typography>
                </Grid>
            </Grid>
            </Box>
            </Grid>
