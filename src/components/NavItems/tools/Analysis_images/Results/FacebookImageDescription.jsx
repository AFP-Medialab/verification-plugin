      ...
      <TableBody>
        ...
        {report.image.length && (
          <TableRow>
            ...
            <TableCell align="right">{report.image.length}</TableCell>
          </TableRow>
        )}
        ...
        {report.image.created_time && (
          <TableRow>
            ...
            <TableCell align="right">{report.image.created_time}</TableCell>
          </TableRow>
        )}
        {report.image.updated_time && (
          <TableRow>
            ...
            <TableCell align="right">{report.image.updated_time}</TableCell>
          </TableRow>
        )}
        {report.verification_cues.twitter_search_url && (
          <TableRow>
            ...
            <TableCell align="right">
              <a
                href={report.verification_cues.twitter_search_url}
