...
const TwitterAdvancedSearch = () => {
    ...
    return (
        <div>
            <HeaderTool name={keywordAllTools("navbar_twitter")} description={keywordAllTools("navbar_twitter_description")} icon={<TwitterAdvancedSearchIcon style={{ fill: "#51A5B2" }} width="40px" height="40px"/>}/>
