...
import { setStateLoading, setStateShow, setStateError} from "../../../../../redux/reducers/tools/gifReducer"
    ...
    useEffect(() => {
        ...
        const getImages = (response) => {
            ...
            if(response.data.status === "KO"){
                ...
                dispatch(setStateShow({homoImg1:homoImage1, homoImg2:homoImage2, toolState:5}));
            }
