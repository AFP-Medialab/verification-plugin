...
export default function assistantApiCalls() {
  ...
  //load scripts that may have been used for training or provided as feedback
  const callOcrFeedbackScriptService = async () => {
    const result = await axios.get("http://localhost:8025/scripts");
    return result.data;
  };
